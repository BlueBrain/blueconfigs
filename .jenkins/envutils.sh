...
bb5_run() (
    ...
    if [ $LONG_RUN = "yes" ]; then
      SALLOC_PARTITION="phase2_all"
      cmd_base="time salloc -N$N --ntasks-per-node=40 -Aproj95 -p$SALLOC_PARTITION --exclusive --mem=0 --time 4:00:00 srun dplace "
    else
