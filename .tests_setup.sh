...
SCIPY_DEP="^py-scipy%gcc"
NEURODAMUS_PY_VERSION="py-neurodamus $BUILD_VERSION $SCIPY_DEP"
...
TESTS[hippocampus]="hip-v6 hip-v6-mcr4 quick-hip-sonata quick-hip-projSeed quick-hip-multipopulation"
