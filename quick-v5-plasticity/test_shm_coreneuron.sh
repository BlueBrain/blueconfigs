...
RUN_PY_TESTS=yes SHM_ENABLED=ON run_blueconfig ${blueconfig} | tee "${outputdir}/sim.log"
...
RUN_PY_TESTS=yes SHM_ENABLED=ON run_blueconfig ${blueconfig}_multi | tee "${outputdir}_multi/sim.log"
