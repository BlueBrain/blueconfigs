...
run_long_test() (
    ...
    # Run all long tests with CoreNEURON apart from scx-v5-plasticity that has
    ...
    test_check_results "$outputdir" "${REF_RESULTS_LONGRUN[$testname]}" "${REF_RESULTS_LONGRUN[$testname]}/out.h5" 0.1
